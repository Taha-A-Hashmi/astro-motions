...
const settingsAndHome = [
  ...
  },
  {
    ...
    fields: [
      ...
      text('contact.firstNameLabel', 'Field label · first name', { max: 24, target: { sel: 'contact.firstNameLabel' } }),
      text('contact.lastNameLabel', 'Field label · last name', { max: 24, target: { sel: 'contact.lastNameLabel' } }),
      text('contact.emailLabel', 'Field label · email', { max: 24, target: { sel: 'contact.emailLabel' } }),
      text('contact.countryLabel', 'Field label · country', { max: 24, target: { sel: 'contact.countryLabel' } }),
      text('contact.phoneLabel', 'Field label · phone', { max: 24, target: { sel: 'contact.phoneLabel' } }),
      text('contact.messageLabel', 'Field label · description', { max: 40, target: { sel: 'contact.messageLabel' } }),
